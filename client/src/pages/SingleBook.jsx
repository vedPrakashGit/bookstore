...
const SingleBook = ({
  ...
  return (
    <div>
            ...
            {user && user.isAdmin && (
              <div>
                ...
                <button
                  ...
                  className="mt-3 w-full py-2 border-red-600 bg-red-600 hover:bg-red-700 hover:border-red-700 block mt-2 outline-current"
                >
                  Delete the book
                </button>
              </div>
      ...
      {!book ? (
        <div className="max-w-2xl mx-auto p-6 my-8 border rounded text-center my-20">
