    ...
    <div className="py-4 sm:py-8 px-2 lg:px-4">
      <div className="flex justify-between items-center">
        ...
        {cartItems.length ? (
          ...
          >
            <button className="bg-amber-200 text-black py-2 px-6 hover:bg-amber-300 active:bg-amber-400">
              Checkout
            </button>
          </StripeCheckout>
        ) : (
      ...
      {cartItems && cartItems.length == 0 && (
        <div className="px-4 py-6 md:p-6 my-8 border rounded text-center w-full w-3/5 mx-auto">
      ...
      {cartItems.length && (
        <div className="text-center mt-10">
          ...
          >
            <button
              onClick={checkout}
              className="px-10 py-3 bg-amber-200 hover:bg-amber-300 text-black text-lg"
            >
              Checkout Now
            </button>
          </StripeCheckout>
